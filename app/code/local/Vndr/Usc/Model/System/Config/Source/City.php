...
class Vndr_Usc_Model_System_Config_Source_City
{
    /**
     * @var array 
     */
    ...
    public function toOptionArray($isMultiselect=false)
    {
        if ( !$this->_optionArray ) {
            foreach (self::getRegions() as $regionKey => $region) {
                
                $this->_optionArray['r'.$regionKey] = array(
                        'label' => $region['name'],
                        'value' => array()
                    );
                
                foreach ($region['city'] as $cityKey => $city) {
                    $this->_optionArray['r'.$regionKey]['value'][] = array(
                        'label' => $city['name'],
                        'value' => sprintf('r%sc%s', $regionKey, $cityKey)
                    );
                }
            }
        }
    ...
    public function toArray()
    {
        if ( !$this->_options ) {
            foreach (self::getRegions() as $regionKey => $region) {
                foreach ($region['city'] as $cityKey => $city) {
                    $this->_options[sprintf('r%sc%s', $regionKey, $cityKey)] = $city['name'];
                }
            }
        }
    ...
    /**
     * Retrieve array of region/city
     * 
     * @todo need to refactor (added timely, cities will move into db in future)
     * @return array
     */
    private static function getRegions()
    {
        ...
        return json_decode($regionCitiesJson, true)['regions'];
    }
}
